namespace xbuffer
{
    ...
    {
        public static #CLASS_NAME# deserialize(byte[] buffer, ref int offset)
        {
...
#DESERIALIZE_RETURN#
        ...
        public static void serialize(#CLASS_NAME# value, byte[] buffer, ref int offset)
        {
#IF_SERIALIZE_CLASS#
            // null
...
#SERIALIZE_PROCESS#
			// #VAR_NAME#
#IF_SINGLE#
			#VAR_TYPE#Buffer.serialize(value.#VAR_NAME#, buffer, ref offset);
#END_SINGLE#
#IF_ARRAY#
            intBuffer.serialize(value.#VAR_NAME#.Length, buffer, ref offset);
            for (int i = 0; i < value.#VAR_NAME#.Length; i++)
            {
                #VAR_TYPE#Buffer.serialize(value.#VAR_NAME#[i], buffer, ref offset);
            }
#END_ARRAY#
#SERIALIZE_PROCESS#
        }
